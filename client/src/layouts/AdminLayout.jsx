...
const adminMenuItems = [
  ...
  { label: 'Cài đặt', path: '/admin/settings', icon: '◎' }
];

function AdminSidebar({ user, onNavigate }) {
  return (
    <aside className="flex h-screen w-72 shrink-0 flex-col overflow-hidden border-r border-slate-200 bg-white shadow-[18px_0_60px_rgba(15,23,42,0.06)]">
